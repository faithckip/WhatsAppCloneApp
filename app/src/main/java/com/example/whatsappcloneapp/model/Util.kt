...
@Composable
fun NotificationMessage(vm: WhatsAppViewModel) {
...
@Composable
fun CheckSignedIn(vm: WhatsAppViewModel, navController: NavController) {
...
@Composable
fun CommonDivider() {
    //will be used as common spacer across just like spacer
    Divider(
        color = Color.LightGray,
        thickness = 1.dp,
        modifier = Modifier
            .alpha(0.3f)//to make it a bit more transparent
...
@Composable
fun CommonImage(
    data: String?, //with ? makes it a nullable string
